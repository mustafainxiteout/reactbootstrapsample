...
function UserDetails() {
  return (
    <div className="googlesans bg-white px-6 py-12 lg:px-8">
        ...
        <h2 className="text-3xl font-bold tracking-wider text-gray-900 sm:text-4xl">User Details</h2>
        ...
        <div className="m-5 mt-0 d-flex gap-3">
          <button
            type="submit"
